...
- Browse the [source repository][repository] and use the
  [public issue tracker][issue-tracker] for defects, integration questions,
  and feature requests. Include the package, Flutter, Dart, native SDK, OS,
  and device versions; expected and actual behavior; a minimal reproduction;
  and redacted logs.
- For account, credential, or service requests that should not be public,
  email [nocturne@asleep.ai][support-email].
...
- To propose a source contribution, read [CONTRIBUTING.md][contributing] and
  open a pull request. A merged change does not guarantee an immediate release.

The source repository and issue tracker are public and are included in the
package metadata. The API reference above remains the canonical generated
Flutter documentation URL. Never send API keys, access tokens, raw audio,
sleep reports, user identifiers, signing material, or other personal data
through any intake route.
...
[repository]: https://github.com/asleep-ai/asleep-sdk-flutter
[issue-tracker]: https://github.com/asleep-ai/asleep-sdk-flutter/issues
[contributing]: https://github.com/asleep-ai/asleep-sdk-flutter/blob/main/CONTRIBUTING.md
